...
function createRelationshipValidationString({ node, context, varName, }) {
    const strs = [];
    node.relationFields.forEach((field) => {
        ...
        let predicate = `c = 1`;
        let errorMsg = `${constants_1.RELATIONSHIP_REQUIREMENT_PREFIX}${node.name}.${field.fieldName} required`;
