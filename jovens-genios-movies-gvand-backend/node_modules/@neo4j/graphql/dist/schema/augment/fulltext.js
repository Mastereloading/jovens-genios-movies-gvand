...
exports.augmentFulltextSchema = exports.fulltextArgDeprecationMessage = void 0;
...
const fulltext_2 = require("../../graphql/directives/fulltext");
exports.fulltextArgDeprecationMessage = "This argument has been deprecated and will be removed in version 4.0.0 of the library. " +
...
function augmentFulltextSchema(node, composer, nodeWhereTypeName, nodeSortTypeName) {
    if (node.fulltextDirective) {
        const fields = node.fulltextDirective.indexes.reduce((res, index) => {
            ...
            return {
                ...
                [indexName]: composer.createInputTC({
                    name: `${node.name}${(0, upper_first_1.upperFirst)(indexName)}Fulltext`,
                    fields: {
        ...
        composer.createInputTC({
            ...
            fields: {
                [fulltext_2.SCORE_FIELD]: "SortDirection",
        ...
        composer.createInputTC({
            ...
            fields: {
                [fulltext_2.SCORE_FIELD]: FloatWhere_1.FloatWhere.name,
        ...
        composer.createObjectTC({
            ...
            fields: {
                [fulltext_2.SCORE_FIELD]: new graphql_1.GraphQLNonNull(graphql_1.GraphQLFloat),
        ...
        node.fulltextDirective.indexes.forEach((index) => {
            ...
            let queryName = `${node.plural}Fulltext${(0, upper_first_1.upperFirst)(indexName)}`;
            if (index.queryName) {
                queryName = index.queryName;
            }
            composer.Query.addFields({
                [queryName]: (0, fulltext_1.fulltextResolver)({ node }, index),
            });
        });
    }
}
