...
const DEPRECATION_WARNING = "The @computed directive has been deprecated and will be removed in version 4.0.0. Please use " +
...
exports.ERROR_MESSAGE = "Required fields of @customResolver must be a list of strings";
let deprecationWarningShown = false;
function getCustomResolverMeta(field, object, customResolvers, interfaceField) {
    const deprecatedDirective = field.directives?.find((x) => x.name.value === "computed") ||
    ...
    if (object.kind !== graphql_1.Kind.INTERFACE_TYPE_DEFINITION && directive && !customResolvers?.[field.name.value]) {
...
exports.default = getCustomResolverMeta;
